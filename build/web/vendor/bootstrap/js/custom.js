...
function KeepCount(j) {
	...
	if (document.form.day1.checked) {
		NewCount = NewCount + 1
	}
	if (document.form.day1.checked) {
		NewCount = NewCount + 1
	}
	if (document.form.day2.checked) {
		NewCount = NewCount + 1
	}
	if (document.form.day3.checked) {
		NewCount = NewCount + 1
	}
	if (document.form.day4.checked) {
		NewCount = NewCount + 1
	}
	if (document.form.day5.checked) {
		NewCount = NewCount + 1
	}
	if (document.form.day6.checked) {
		NewCount = NewCount + 1
	}
