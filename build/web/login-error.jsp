...
<title>Login | College Time Table Generator</title>
...
<body style="background-image: url('img/lib.jpg'); background-attachment: fixed;">
	...
	<nav id="mainNav"
		...
		<div class="container">
			...
			<div class="navbar-header page-scroll">
				<a class="navbar-brand page-scroll" href="#page-top">College Time Table Generator</a>
			</div>
		</div>
	</nav>
	...
	<div class=row>
		...
		<div class="container col-sm-4 ">
			<div class=jumbotron>
				<div style="text-align: center;color: red;text-decoration: underline;">Inavalid username or password. Try again.</div>
