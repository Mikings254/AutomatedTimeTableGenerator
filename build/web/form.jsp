...
<body id="page-top" class="index"
	...
	<div class="row">
		...
		<div class="col-sm-8">
			<div class="jumbotron"
				...
				<hr>
				<form role="form" action="view_timetable_form" method="post" name="form"
					id="form">
					...
					<hr>
                                        ...
                                        <button type="submit" id="sub1" class="btn btn-default">Submit</button>

				</form>
				<hr />
				<span
					style="text-decoration: underline; text-shadow: black; font-size: medium;"><a
                                        href="view-timetable"><i style="color:red">Test With Static data(file)</i></a></span>
			</div>
		</div>
    ...
    function chk(){
        ...
        var dd1 = document.form.daysperweek.value;
        console.log(dayscnt +" "+dd1);
        if(dayscnt<parseInt(dd1))
        {
            
            alert("Please select "+dd1+"days..");
            return  false;
        }
        else
        {
