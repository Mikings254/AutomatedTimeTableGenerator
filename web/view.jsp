...
<%
        ...
        String dayName[]=new String[]{"Monday","Tuesday","Wednesday","Thursday","Friday"};
        boolean flag=false;
	...
	for(int i=0;i<nostgrp;i++){
			...
			for(int k=0;k<hours;k++){
				...
				if(TimeTable.slot[gene[i].slotno[k+j*hours]]!=null){
					String teachername=scheduler.inputdata.teacher[TimeTable.slot[gene[i].slotno[k+j*hours]].teacherid].getName();
                                         ...
                                         if(TimeTable.slot[gene[i].slotno[k+j*hours]].isPract && !flag)
                                         {
                                         out.print("<td colspan='2' style='text-align:center;color:red;background-color:yellow;border-right: 0px solid #FFFFFF'   >"+TimeTable.slot[gene[i].slotno[k+j*hours]].subject+"<br>"+teachername+"</td>");
                                         flag=true;
                                         }
                                        else if(TimeTable.slot[gene[i].slotno[k+j*hours]].isPract && flag)
                                         {
                                        // out.print("<td colspan='2' style='text-align:center;color:red;background-color:yellow;border-right: 0px solid #FFFFFF'   >"+TimeTable.slot[gene[i].slotno[k+j*hours]].subject+"<br>"+teachername+"</td>");
                                         flag=false;
                                         }
		...
		out.print("</tbody></table></div><hr><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>");
